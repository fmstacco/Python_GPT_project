...
def analisador_sentimentos(produto):
    ...
    prompt_usuario = carrega(f"/workspaces/Python_GPT_project/avaliacoes-{produto}.txt")
...
lista_de_produtos = ["Camisetas de algodao organico", "Jeans feitos com materiais reciclados", "Maquiagem mineral"]
